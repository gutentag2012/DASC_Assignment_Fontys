...
next step is to assure that there is no collinearity between the different variables of the multiple linear regression and to look at the summary for 
the model.
...
Looking at the last values from the vif command, they fall way below 5 and can therefore be read as a low risk of collinearity in this model; 
...
variables and negative, which explains them having a lower curve in the plot before. Also the estimated impact of the categories is low compared
to the estimate for the relevance, which tells us, that the categories are not the main influence in this model, but still have some influence. <br/>
