...
hist(reg$residuals,
     col = "#cc0000",
     main = "Resudial spread",
     xlab = "Residuals")
```

This plot show, that we have a high number of low negative residuals, that are cancelled out by a lower number of high positive residuals. This is
